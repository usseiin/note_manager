...
import 'shared_note_q_d_model.dart';
export 'shared_note_q_d_model.dart';

class SharedNoteQDWidget extends StatefulWidget {
  const SharedNoteQDWidget({Key? key}) : super(key: key);

  @override
  _SharedNoteQDWidgetState createState() => _SharedNoteQDWidgetState();
}

class _SharedNoteQDWidgetState extends State<SharedNoteQDWidget> {
  late SharedNoteQDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SharedNoteQDModel());
