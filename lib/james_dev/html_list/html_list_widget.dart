...
import 'html_list_model.dart';
export 'html_list_model.dart';

class HtmlListWidget extends StatefulWidget {
  const HtmlListWidget({Key? key}) : super(key: key);
...
class _HtmlListWidgetState extends State<HtmlListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HtmlListModel());
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: ShareWidget(
                                                                                  notesRef: listViewNotesRecord.reference,
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          );
